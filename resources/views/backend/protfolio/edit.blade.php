                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="delivery_date" class="form-control" placeholder="Delivery Date" value="{{$protfolios->delivery_date != null ? $protfolios->delivery_date : ''}}" required>
                                    @error('delivery_date')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="client" class="form-control" placeholder="Client" value="{{$protfolios->client != null ? $protfolios->client : ''}}" required>
                                    @error('client')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tage" class="form-control" placeholder="Tage" value="{{$protfolios->tage != null ? $protfolios->tage : ''}}" required>
                                    @error('tage')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote" name="description" class="form-control" required placeholder="description">{!! $protfolios->description !!}</textarea>
                                    @error('description')
                                        <strong class="text-danger">{{$message}}</strong>
                                    @enderror
                                </div>
