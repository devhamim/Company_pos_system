                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            <input type="date" class="form-control datetimepicker" id="delivery_date" name="delivery_date" required>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            <input type="text" class="form-control" id="busines_name" name="busines_name" required>
                                        </div>
                                        <div class="form-group col-md-6 col-12">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-12">
                                            ...
                                            <select name="company_name" id="company_name" class="form-control select2">
                                                <option value="nugortechit">Nugortech IT</option>
