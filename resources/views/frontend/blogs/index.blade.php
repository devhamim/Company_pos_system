        ...
        <div class="row">
                ...
                <div class="inner-box">
                    <div class="image-box">
                        <figure class="image"><a href="news-details.html"><img
                                    src="{{ asset('frontend') }}/images/resource/news1-1.jpg" alt></a></figure>
                    </div>
            ...
            <div class="news-block col-lg-4 col-md-6">
                <div class="inner-box">
                    <div class="image-box">
                        <figure class="image"><a href="news-details.html"><img
                                    src="{{ asset('frontend') }}/images/resource/news1-2.jpg" alt></a></figure>
                    </div>
                    <div class="content-box">
                        <ul class="post">
                            <li>
                        ...
                        <h6 class="title"><a href="news-details.html">The Five Challenges of Digital
                                Marketing Transformation</a></h6>
                    </div>
                </div>
            </div>
            ...
            <div class="news-block col-lg-4 col-md-6">
                <div class="inner-box">
                    <div class="image-box">
                        <figure class="image"><a href="news-details.html"><img
                                    src="{{ asset('frontend') }}/images/resource/news1-3.jpg" alt></a></figure>
                    </div>
                    <div class="content-box">
                        <ul class="post">
                            <li>
                        ...
                        <h6 class="title"><a href="news-details.html">Your Complete Digital Marketing
                                Strategy for 2020</a></h6>
                    </div>
                </div>
            </div>
