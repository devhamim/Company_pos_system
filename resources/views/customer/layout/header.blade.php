            ...
            <div class="row ">
                ...
                <div class="col-lg-2">
                    <div class="header-logo">
                        <a href="index.html"><img src="{{ asset('customer') }}/images/logo/logo.png" alt="Site Logo" /><img
                                class="dark-logo" src="{{ asset('customer') }}/images/logo/dark-logo.png" alt="Site Logo"
                    ...
                    <li><a href="javascript:void(0)">Categories</a>
                        <ul class="sub-menu">
                            ...
                            <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img class="img-responsive"
                                        src="{{ asset('customer') }}/images/menu-banner/1.jpg" alt=""></a>
                            </li>
                        </ul>
                    </li>
