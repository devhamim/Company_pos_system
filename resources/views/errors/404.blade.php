...
<body>
    <div class="page-wrapper">
        ...
        <main class="main">
        	...
        	<div class="error-content text-center" style="background-image: url({{asset('frontend/assets/images/backgrounds/error-bg.jpg')}}); height: 100vh">
            	<div class="container pt-5 mt-5">
            		<h1 class="error-title pt-5 mt-5">Error 404</h1><!-- End .error-title -->
            		<p>We are sorry, the page you've requested is not available.</p>
            		<a href="{{route('site')}}" class="btn btn-outline-primary-2 btn-minwidth-lg">
